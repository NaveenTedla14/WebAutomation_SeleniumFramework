...
public class ExtentTestNGIReporterListener extends InitMethod implements IReporter {
    ...
    public void generateReport(List xmlSuites, List suites, String outputDirectory) {
        ...
        extent.setSystemInfo("Author", "Naveen Tedla");
    ...
    private void init() {
        ...
        sparkReporter.config().setDocumentTitle("Extent Report_Naveen Tedla");
        sparkReporter.config().setReportName("Extent Report_Naveen Tedla");
